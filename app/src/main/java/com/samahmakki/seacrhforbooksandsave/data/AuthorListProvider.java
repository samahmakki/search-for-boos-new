...
public class AuthorListProvider extends ContentProvider {
    ...
    private static final int AUTHOR_BOOKS = 300;

    /** URI matcher code for the content URI for a single book in the books table */
    private static final int AUTHOR_BOOK_ID = 301;
    ...
    static {
        ...
        sUriMatcher.addURI(BookContract.CONTENT_AUTHORITY_AUTHOR_ENTRY, BookContract.PATH_AUTHOR_ENTRY, AUTHOR_BOOKS);

        sUriMatcher.addURI(BookContract.CONTENT_AUTHORITY_AUTHOR_ENTRY, BookContract.PATH_AUTHOR_ENTRY + "/#", AUTHOR_BOOK_ID);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch (match) {
            case AUTHOR_BOOKS:
                ...
                cursor = database.query(AuthorEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case AUTHOR_BOOK_ID:
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (match) {
            case AUTHOR_BOOKS:
                return AuthorEntry.CONTENT_LIST_TYPE;
            case AUTHOR_BOOK_ID:
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        long id = database.insert(AuthorEntry.TABLE_NAME, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            case AUTHOR_BOOKS:
                ...
                // For  case PETS:
                rowsDeleted = database.delete(AuthorEntry.TABLE_NAME, selection, selectionArgs);
