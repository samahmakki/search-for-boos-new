...
public class TopicListProvider extends ContentProvider {
    ...
    private static final int TOPIC_BOOKS = 500;

    /** URI matcher code for the content URI for a single book in the books table */
    private static final int TOPIC_BOOK_ID = 501;
    ...
    static {
        ...
        sUriMatcher.addURI(BookContract.CONTENT_AUTHORITY_TOPIC_ENTRY, BookContract.PATH_TOPIC_ENTRY, TOPIC_BOOKS);

        sUriMatcher.addURI(BookContract.CONTENT_AUTHORITY_TOPIC_ENTRY, BookContract.PATH_TOPIC_ENTRY + "/#", TOPIC_BOOK_ID);
    }

    /** Tag for the log messages */
    public static final String LOG_TAG = TopicListProvider.class.getSimpleName();
    private TopicListDbHelper mDbHelper;

    @Override
    public boolean onCreate() {
        // TODO: Create and initialize a BookDbHelper object to gain access to the pets database.
        mDbHelper = new TopicListDbHelper(getContext());
